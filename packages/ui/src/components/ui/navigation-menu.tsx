...
const navigationMenuTriggerStyle = cva(
  "ui-group ui-inline-flex ui-h-10 ui-w-max ui-items-center ui-justify-center ui-rounded-md ui-bg-white ui-px-4 ui-py-2 ui-text-sm ui-font-medium ui-transition-colors hover:ui-bg-slate-100 hover:ui-text-slate-900 focus:ui-bg-slate-100 focus:ui-text-slate-900 focus:ui-outline-none disabled:ui-pointer-events-none disabled:ui-opacity-50 data-[active]:ui-bg-slate-100/50 data-[state=open]:ui-bg-slate-100/50 dark:ui-bg-slate-950 dark:hover:ui-bg-slate-800 dark:hover:ui-text-slate-50 dark:focus:ui-bg-slate-800 dark:focus:ui-text-slate-50 dark:data-[active]:ui-bg-slate-800/50 dark:data-[state=open]:ui-bg-slate-800/50"
)
...
>(({ className, ...props }, ref) => (
  <div className={cn("ui-absolute ui-left-0 ui-top-full ui-flex ui-justify-center")}>
    <NavigationMenuPrimitive.Viewport
      className={cn(
        "ui-origin-top-center ui-relative ui-mt-1.5 ui-h-[var(--radix-navigation-menu-viewport-height)] ui-w-full ui-overflow-hidden ui-rounded-md ui-border ui-border-slate-200 ui-bg-white ui-text-slate-950 ui-shadow-lg data-[state=open]:ui-animate-in data-[state=closed]:ui-animate-out data-[state=closed]:ui-zoom-out-95 data-[state=open]:ui-zoom-in-90 md:ui-w-[var(--radix-navigation-menu-viewport-width)] dark:ui-border-slate-800 dark:ui-bg-slate-950 dark:ui-text-slate-50",
        className
      )}
      ref={ref}
      {...props}
