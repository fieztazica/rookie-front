...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "ui-rounded-lg ui-border ui-border-slate-200 ui-bg-white ui-text-slate-950 ui-shadow-sm dark:ui-border-slate-800 dark:ui-bg-slate-950 dark:ui-text-slate-50",
      className
    )}
    {...props}
  />
